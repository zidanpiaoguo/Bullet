 ...
 *  viewpager的指示器
 *
 *  附加内容：  animator:   indicator_scale_alpha.xml
 *              drawable:   indicator_selected_radius.xml    indicator_unselected_radius.xml
 *              values/attrs:      CircleIndicator
 *              
 * @author bullet
 * @date 2019\1\4 0004.
 */
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.indiactor_scale_alpha;
    private int mAnimatorReverseResId = 0;
    private int mIndicatorBackgroundResId = R.drawable.indicator_selected_radius;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.indicator_unselected_radius;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                R.animator.indiactor_scale_alpha);
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                        R.drawable.indicator_selected_radius);
    ...
    /**
     * Create and configure IndicatorAcitivity in Java code.
     */
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.indiactor_scale_alpha, 0, R.drawable.indicator_selected_radius, R.drawable.indicator_selected_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.indiactor_scale_alpha : mAnimatorResId;
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.indicator_selected_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
